              ...
              <tbody>
                {loading ? (
                  Array.from({ length: 8 }).map((_, index) => (
                    <tr key={`product-loading-${index}`} className="pr-row pr-row--loading">
                      <td colSpan={7}>
                        <div className="pr-loading-row">
                          <div className="pr-loading-row__main">
                            <span className="pr-loading-line pr-loading-line--sm" />
                            <span className="pr-loading-line pr-loading-line--md" />
                          </div>
                          <div className="pr-loading-row__meta">
                            <span className="pr-loading-pill" />
                            <span className="pr-loading-pill" />
                          </div>
                        </div>
                      </td>
