    ...
    <div className="incomes-page">
      ...
      <div className="ic-topbar">
        ...
        <div className="ic-top-actions">
          <Link href="/orders" className="ic-btn ic-btn-link">
            Orders
          </Link>
              ...
              <tbody>
                {loading ? (
                  Array.from({ length: 8 }).map((_, index) => (
                    <tr key={`income-loading-${index}`} className="ic-row ic-row--loading">
                      <td colSpan={8}>
                        <div className="ic-loading-row">
                          <div className="ic-loading-row__main">
                            <span className="ic-loading-line ic-loading-line--sm" />
                            <span className="ic-loading-line ic-loading-line--md" />
                          </div>
                          <div className="ic-loading-row__meta">
                            <span className="ic-loading-pill" />
                            <span className="ic-loading-line ic-loading-line--sm" />
                          </div>
                        </div>
                      </td>
                  ...
                  <tr>
                    <td colSpan={8} className="ic-table-empty">
