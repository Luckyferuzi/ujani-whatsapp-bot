    ...
    <div className="expenses-page">
      ...
      <div className="ex-topbar">
        ...
        <div className="ex-top-actions">
          <Link href="/incomes" className="ex-btn ex-btn-link">
            Income
          </Link>
              ...
              <tbody>
                {loading ? (
                  Array.from({ length: 8 }).map((_, index) => (
                    <tr key={`expense-loading-${index}`} className="ex-row ex-row--loading">
                      <td colSpan={6}>
                        <div className="ex-loading-row">
                          <div className="ex-loading-row__main">
                            <span className="ex-loading-line ex-loading-line--sm" />
                            <span className="ex-loading-line ex-loading-line--md" />
                          </div>
                          <div className="ex-loading-row__meta">
                            <span className="ex-loading-pill" />
                            <span className="ex-loading-line ex-loading-line--sm" />
                          </div>
                        </div>
                      </td>
                  ...
                  <tr>
                    <td colSpan={6} className="ex-table-empty">
