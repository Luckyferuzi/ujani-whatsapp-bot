...
const dict: Dict = {
  ...
  'Oda yako {code} imekabidhiwa mpeleka mzigo na iko njiani kufika. Namba ya mpeleka mzigo ni {agentPhone}. Tafadhali mpigie au mtumie message kwa mawasiliano zaidi',
